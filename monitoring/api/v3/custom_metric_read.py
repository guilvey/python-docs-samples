...
def get_start_time():
    ...
    #tart_time = datetime.datetime.utcnow() - datetime.timedelta(minutes=5)
...
def main(project_id, metric_uri):
    ...
    timeseries = read_timeseries(client, project_resource, metric_uri )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--metric_uri', help='Metric to fetch.', required=True)

    args = parser.parse_args()
    main(args.project_id, args.metric_uri)
